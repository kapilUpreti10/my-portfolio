...
const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // This is where you would authenticate with a real backend
      if (email === "user@example.com" && password === "password") {
        toast.success(`Welcome back${userType === "driver" ? " driver" : ""}!`);
        navigate("/");
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-accent/50 px-4 py-12">
      <Card className="w-full max-w-md mx-auto">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">Sign in to RideNow</CardTitle>
